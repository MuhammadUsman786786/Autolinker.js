...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    // objects each time (which is very expensive - see https://github.com/gregjacobs/Autolinker.js/issues/314). 
    // See descriptions of the properties where they are used for details about them
    var userMentionRegex = new RegExp(/@(.[^@:]+):\w+(\s|$)/g); // lookahead used to make sure we don't match something above 50 characters
    ...
    var Autolinker = /** @class */ (function () {
        ...
        function Autolinker(cfg) {
            ...
            if (mention !== false && mention !== 'twitter' && mention !== 'instagram' && mention !== 'soundcloud' && mention !== 'userMention') {
                throw new Error("invalid `mention` cfg - see docs");
            }
            // Validate the value of the `hashtag` cfg
            var hashtag = this.hashtag;
            if (hashtag !== false && hashtag !== 'twitter' && hashtag !== 'facebook' && hashtag !== 'instagram' && mention !== 'userMention') {
